...
from apps import home, data, samplelulc  # import your app modules here
...
apps = [
    ...
    {"func": samplelulc.app, "title": "samplelulc", "icon": "layers-half"},
    {"func": data.app, "title": "Upload", "icon": "cloud-upload"}
]
